...
<link href='https://fonts.googleapis.com/css?family=Lora' rel='stylesheet' type='text/css'>
  ...
  #logo-img {
    background: url('D:\IMAGES\restaurant-logo_large.png') no-repeat;
    width: 150px;
    height: 150px;
  ...
  #menu-tile {
    background: url('D:/IMAGES/menu-tile.jpg') no-repeat;
    background-position: center;
  
  }
  #specials-tile {
    background: url('D:/IMAGES/specials-tile.jpg') no-repeat;
    background-position: center;
  }
  ...
  @media (min-width: 1200px) {
    .container .jumbotron {
      background: url('D:/IMAGES/jumbotron_1200.jpg') no-repeat;
      height: 675px;
  ...
  @media (min-width: 992px) and (max-width: 1199px) {
    /* Header */
    #logo-img {
      background: url('D:/IMAGES/restaurant-logo_medium.png') no-repeat;
      width: 100px;
      height: 100px;
    ...
    /* Home Page */
    .container .jumbotron {
      background: url('D:/IMAGES/jumbotron_992.jpg') no-repeat;
      height: 558px;
    }
  ...
  @media (min-width: 768px) and (max-width: 991px) {
    /* Home Page */
    .container .jumbotron {
      background: url('D:/IMAGES/jumbotron_768.jpg') no-repeat;
      height: 432px;
    }
    /* End Home Page */
  }
